...
export default function Footer() {
  return (
    ...
    >
      <div className="max-lg:w-[80%] max-w-[1300px] mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-3 space-y-5 lg:space-x-20 py-10">
        <div className="flex flex-col lg:mr-10 gap-6 pb-7 w-fit">
          ...
          <div className="flex rounded-md h-[50px] lg:w-[350px]">
            <input
              ...
              name=""
            />
            <button className="bg-[#3D59FA] rounded-r-md text-white px-3 -ml-1">Subscribe</button>
          </div>
      ...
      <div className="h-[1px] bg-[#c2c2c2]"></div>
      <div className="max-w-[1300px] mx-auto flex flex-col lg:flex-row lg:justify-between items-center gap-2 pt-3">
        <div>
