...
export default function HeroSection() {
  return (
    <div
      className="lg:flex bg-cover bg-center h-fit w-full"
      style={{ backgroundImage: 'url("/home.png")' }}
    >
      <div className="mx-auto max-w-[80%] space-y-5 pt-32">
        ...
        <div className="flex justify-center gap-5 text-[14px] text-[#F5FAFF]">
